...
public class TrybeGamesController
{
    ...
    {
        int listLenght = database.Players.Count;
        listLenght++;
        Console.WriteLine("Adicionar nova pessoa jogadora:");
    ...
    {
        int listLenght = database.GameStudios.Count;
        listLenght++;
        Console.WriteLine("Adicionar novo Game Studio");
        ...
        Console.WriteLine("Estudio adicionado");
    }
